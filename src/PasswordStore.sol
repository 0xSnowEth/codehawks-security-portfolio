...
contract PasswordStore {
    ...
    // @audit - The s_password can still be accessed by anyone who knows the storage slot, making your password private does not mean it is secure or safe!!
    ...
    // Common Attack - Missing Access Control.
